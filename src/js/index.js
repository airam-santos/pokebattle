...
button.addEventListener('click', function() {
    ...
    const imagename1=/...namepokemon1+"*.png"}$/;
    pokemon1.innerHTML=`<img src="img/${images[imagename1]}" alt="${namepokemon1}"></img>`; //No encuentra imagen
    pokemon2.innerHTML=`<img src="img/${images[/.${namepokemon2.png}$/]}" alt="${namepokemon2}"></img>`;
