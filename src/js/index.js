...
button.addEventListener('click', function() {
    ...
    pokemon1.innerHTML=`<img src="img/${images[chosen[0]]}" alt="${namepokemon1}"></img>`; //No encuentra imagen
    pokemon2.innerHTML=`<img src="img/${images[chosen[1]]}" alt="${namepokemon2}"></img>`;
